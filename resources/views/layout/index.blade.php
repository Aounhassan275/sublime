			...
			<div class="sidebar-content">
					...
					<div class="card-body">
						<div class="media">
							<div class="media-body">
								<div class="media-title font-weight-semibold">Aoun Hassan</div>
								<div class="font-size-xs opacity-50">TT Inc.
								</div>
							</div>
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item">
							<a href="{{route('item.view')}}" class="nav-link {{Request::is('/')?'active':''}}">
                        ...
                        <li class="nav-item">
							<a href="{{route('model.index')}}" class="nav-link {{Request::is('model')?'active':''}}">
								<i class="icon-home4"></i>
								<span>Model</span>
							</a>
						</li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><a href="{{route('item.view')}}"><i class="icon-arrow-left52 mr-2"></i></a><span class="font-weight-semibold">@yield('title')</span></h4>
